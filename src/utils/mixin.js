...
let dicObj = storage.getItem('dic')
if (dicObj) {
  Vue.prototype.dicObj = JSON.parse(storage.getItem('dic'))
}

Vue.prototype.$_setDic = (dic) => {
  Vue.prototype.dicObj = dic
}
Vue.prototype.dicFormater = function (typeKey, enumValue) {
...
Vue.prototype.$_loadingObj = false
...
Vue.prototype.$_showLoading = function(options = {}) {
  if (!this.$_loading) {
    this.$_loadingObj = Loading.service({
      lock: true,
