<template>
  <div class="view-approval-common">
    <vue-scroll>
      <s-title :titleArr="titleArr" :haveBorder="true"></s-title>
      <div class="view-body">
        <h2 class="view-title">查看【编号：{{approvalDetail.exchangeNumber}}】</h2>
        <!--调课日期  -->
        <div class="view-date">
          ...
          <div class="progress-list">
            ...
            >
              ...
              >
                ...
                <span v-else-if="item.approvalState === null">未审核</span>
                <span
                  v-else
