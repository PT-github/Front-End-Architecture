<template>
  <div style="margin-top: 1000px" class="print-class-table">
    <div id="AA" style="width: 100%;">
      <p style="margin-left: 40%; font-weight: bold; font-size: 16px; margin-bottom: 10px">{{printContent.schoolYearName}}({{printContent.termName}})班级课表</p>
      <el-table :data="tableData3" style="width: 100%;">
        <el-table-column label="节数/星期" width="139" align="center">
        ...
        >
          <template slot-scope="scope" v-if="scope.row['week' + (index + 1)]">
            ...
            <p class="name" v-if="showTeacher" style="color: #000000">{{ scope.row['week' + (index + 1)].teacherName }}</p>
