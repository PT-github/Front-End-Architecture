<template>
  <div class="test-container">
    <div class="drag-content">
      <draggable ref="drag" :storageDragging="storageDragging" :storageDragData="storageDragData" :list="list" :options="options" @dragOutOfBound="dragOutOfBound" @exchangeData="exchangeData" @changed="changed"></draggable>
    </div>
